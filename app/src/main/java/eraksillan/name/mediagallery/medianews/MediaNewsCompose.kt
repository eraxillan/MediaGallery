...
@Composable
fun MediaNewsCompose(data: List<LocalMedia.NewsItem>, viewModel: MediaNewsViewModel) {
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = { viewModel.onEvent(MediaNewsAction.NavigateBackClicked) }) {
                        Icon(
...
@Composable
private fun MediaNewsContentCompose(
    data: List<LocalMedia.NewsItem>,
    onEvent: (MediaNewsAction) -> Unit,
                ...
                Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
                    AsyncImage(
                        ...
                        modifier = Modifier
                            .width(64.dp)
                            .height(64.dp)
                            .clickable { onEvent(MediaNewsAction.NewsItemClicked(newsItem.malId)) },
