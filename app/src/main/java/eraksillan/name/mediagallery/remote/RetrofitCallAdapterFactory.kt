...
class RetrofitCallAdapterFactory private constructor() : CallAdapter.Factory() {
    ...
    override fun get(
        ...
        if (getRawType(callType) != RetrofitNetworkResult::class.java) {
            return null
        }

        val resultType = getParameterUpperBound(0, callType as ParameterizedType)
        return RetrofitCallAdapter(resultType)
    }

    companion object {
        fun create(): RetrofitCallAdapterFactory = RetrofitCallAdapterFactory()
    }
}
