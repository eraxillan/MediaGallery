...
class PagingMediaRepository @Inject constructor(
    ...
    fun getMediaCast(id: Int): Flow<NetworkResult<LocalMediaCast>> = flow {
        emit(repository.getAnimeCharacters(id))
    }

    fun getMediaStaff(id: Int): Flow<NetworkResult<LocalMediaStaff>> = flow {
        emit(repository.getAnimeStaff(id))
    }

    fun getMediaThemes(id: Int): Flow<NetworkResult<LocalMediaThemes>> = flow {
        emit(repository.getAnimeThemes(id))
    }
    ...
    fun getMediaNews(id: Int): Flow<NetworkResult<LocalMediaNews>> = flow {
        emit(repository.getAnimeNews(id))
    }

    fun getMediaDiscussions(id: Int): Flow<NetworkResult<LocalMediaDiscussions>> = flow {
        emit(repository.getAnimeDiscussions(id))
    }

    fun getMediaStatistics(id: Int): Flow<NetworkResult<LocalMediaStatistics>> = flow {
        emit(repository.getAnimeStatistics(id))
    }
